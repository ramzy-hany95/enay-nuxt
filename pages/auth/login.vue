...
function onSubmit() {
  ...
  console.log('login', { phone: phone.value })
  router.push('/')
}
</script>
...
.eye-btn{ position:absolute; right:8px; top:50%; transform:translateY(-50%); background:transparent; border:0; padding:6px; display:flex; align-items:center; justify-content:center }
.forgot{ display:inline-block; text-align:left; margin-left:2px; color:#334e4a; font-size:0.9rem }

.primary-btn{ margin-top:6px; background:#2c8b71; color:white; border:0; padding:14px; border-radius:999px; font-weight:700 }
.signup{ margin-top:8px; color:#4a5b5a }
.signup a{ color:#153233; font-weight:700; text-decoration:underline }
